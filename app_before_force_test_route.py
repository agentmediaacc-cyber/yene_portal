...
@app.route("/zzz_test_weekly_route")
def zzz_test_weekly_route():
    return {"ok": True, "msg": "test route alive"}

@app.route("/api/admin/weekly_agent_report_pdf")
def api_admin_weekly_agent_report_pdf():
    return {"ok": True, "msg": "weekly route alive"}
...
def api_admin_weekly_agent_report_pdf():
    ...
    return jsonify({
        "ok": True,
        "route": "/api/admin/weekly_agent_report_pdf",
