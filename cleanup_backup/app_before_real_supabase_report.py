...
def api_admin_weekly_agent_report_pdf():
    ...
    c.drawString(50, y, "YENE Weekly Agent Report")
    y -= 25

    c.setFont("Helvetica", 11)
    c.drawString(50, y, f"Week Start: {monday.isoformat()}")
    y -= 18
    c.drawString(50, y, f"Week End: {sunday.isoformat()}")
    y -= 30
    ...
    c.setFont("Helvetica", 11)
    c.drawString(50, y, "PDF route is working.")
    y -= 18
    c.drawString(50, y, "Replace this placeholder content with real agent report rows.")
    y -= 18
