...
def api_admin_weekly_agent_report_pdf():
    ...
    c.drawString(left, y, f"Generated from Supabase | Agents with activity this week: {len(rows)}")
    y -= 18

    def ensure_room(min_y=90):
        nonlocal_y = None
    ...
    if not rows:
        ...
        c.drawString(left, y, "No driver/client rows found for the selected week.")
        c.save()
